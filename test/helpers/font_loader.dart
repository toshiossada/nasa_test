...
///included in your pubspec.yaml as well as from
...
/// To make them available in tests, a package needs to include their own
/// copies of them.
///
...
/// prefixed with
/// /packages/{package name}/{fontFamily} in order to disambiguate when
/// multiple packages include
/// fonts with the same name.
///
/// Ultimately, the font loader will load whatever we tell it, so if we see a
/// font that looks like
